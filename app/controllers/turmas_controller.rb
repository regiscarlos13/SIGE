class TurmasController < ApplicationController
  ...
  private
    ...
    def turma_params
      params.require(:turma).permit(:name, :serie_id,
      disciplinaturmas_attributes: [:id, :turma_id, :subject_id, :teacher_id, :hora, :_destroy]
      ).merge(year_id: cookies.encrypted[:selected_year])
    end
end
