class YearsController < ApplicationController
  ...
  # GET /years.json
  def index
    @years = Year.where(school_id: current_user.school.id)
  end
  ...
  private
    ...
    def year_params
      params.require(:year).permit(:year, :media, :inicio, :fim, 
        :inicio1, :fim1, :inicio2, :fim2, :inicio3, :fim3,
        :inicio4, :fim4, :inicior, :fimr).merge(school_id: current_user.school.id)
    end
end
